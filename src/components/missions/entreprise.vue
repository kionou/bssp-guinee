<template >
    <div>
            ...
            <div class="card custom-card">
                <div class="card-header justify-content-between">
                    <div class="card-title">
                        Liste des Entreprises de travaux
                    </div>
                    ...
                    <button v-if="hasPermission(3)" class="btn btn-icon btn-primary ms-2" data-bs-placement="top"
                        data-bs-title="Add Contact" data-bs-toggle="modal" data-bs-target="#add_entreprise">
                        <i class="ri-add-line">
                        </i></button>
                </div>
                                    ...
                                    <td style="width: 100px !important;">
                                        <div class="hstack gap-2 fs-15">
                                            <button v-if="hasPermission(2)"
                                                ...
                                                data-bs-toggle="modal" data-bs-target="#update_entreprise"
        ...
        <div class="modal fade effect-rotate-bottom " id="add_entreprise" tabindex="-1" aria-hidden="true"
            data-bs-backdrop="static" ref="add_entreprise">
                ...
                <div class="modal-content">
                    <div class="modal-header float-start text-center justify-content-center"
                        ...
                        <h2 class="modal-title text-white text-center" id="mail-ComposeLabel"
                            ...
                            <b class="text-center">Ajouter des entreprises de travaux </b>
                        </h2>
                    </div>
                  ...
                  ">
                                        ...
                                        <div class="row  content-group">
                                            ...
                                            <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-12">
                                                <div class="input-groupe">
                                                    <label for="userpassword">Code de l'entreprise de travaux <span
                                            ...
                                            <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-12">
                                                <div class="input-groupe">
                                                    <label for="userpassword">Nom de l'entreprise de travaux <span
                                                            class="text-danger">*</span></label>
                                            ...
                                            <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-12">
                                                <div class="input-groupe">
                                                    <label for="userpassword">Description de l'entreprise </label>
                            ...
                            <div class="row mb-3">
                                <div class="boutton">
                                    <button class="" @click.prevent="submitInfrastructure('add_entreprise')">
                                        Valider
                                    </button>
                                </div>
                            </div>
        ...
        <div class="modal fade effect-rotate-bottom" id="update_entreprise" tabindex="-1" aria-hidden="true"
            data-bs-backdrop="static" ref="update_entreprise">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header float-start text-center justify-content-center"
                        ...
                        <h2 class="modal-title text-white text-center" id="mail-ComposeLabel"
                            style="font-size: 22px !important">
                            <b class="text-center">Modifier une entreprise de travaux </b>
                        </h2>
                    </div>
                    <div class="modal-body px-4">
                        <div class="row gy-2 justify-content-center" style="
                    ...
                    ">
                            <div>
                                ...
                                <div class="row  content-group">
                                    <div class="col">
                                        <div class="input-groupe">
                                            <label for="userpassword">Code de l'entreprise de travaux
                                ...
                                <div class="row mt-3 content-group">
                                    <div class="col">
                                        <div class="input-groupe">
                                            <label for="userpassword">Nom de l'entreprise de travaux
                                                <span class="text-danger">*</span></label>
                                ...
                                <div class="row mt-3 content-group">
                                    <div class="col">
                                        <div class="input-groupe">
                                            <label for="userpassword">Description de l'entreprise de travaux
                                            </label>
                                            <textarea class="form-control"
                                                style="border-radius:0 !important; border:1px solid #e5eaee !important"
                            ...
                            <div class="row mb-3">
                                <div class="boutton">
                                    <button class="" @click.prevent="submitUpdateInfrastructure('update_entreprise')">
                                        Valider
                                    </button>
                                </div>
                            </div>
