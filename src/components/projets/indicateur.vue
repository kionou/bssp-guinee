<template>
  <div>
    ...
    <div class="row task-card">
      ...
      >
        <table
          class="table table-hover text-nowrap table-bordered table-striped"
        >
          <thead>
            <tr class="text-center">
              ...
              <th scope="col">
                <span class="fw-semibold float-left">Intitule</span>
              </th>
              ...
              <th scope="col text-center">
                <span class="fw-semibold">suivre</span>
              </th>
              <th scope="col text-center">
          ...
          <tbody>
            <tr v-for="item in paginatedItems" :key="item.id">
              ...
              <td style="width: 150px">
                <span
                  class="d-block fw-semibold mb-1 text-center"
                  style="color: red"
                >
                  {{ item.CibleFinProjet }}
                </span>
              ...
              <td style="width: 150px">
                <span class="d-block fw-semibold mb-1 text-center text-primary">
              ...
              <td class="text-center" style="width: 180px">
                <div v-if="item.progress.length === 0">
                  ...
                  <router-link
                    :to="{ name: 'suivi-indicateur', params: { id: item.id } }"
                    class="text-white btn btn-secondary btn-sm"
                    v-tippy="{
                      content: 'Suivre cet indicateur',
                      theme: 'custom',
                ...
                {{ realisationPercentage(item).toFixed(2) }}%
                  ...
                  <span
                    ...
                    :style="{
                      color: getProgressColor(realisationPercentage(item)),
                    }"
                  >
                    {{ realisationPercentage(item).toFixed(2) }}%
                  </span>
...
export default {
  ...
  methods: {
    ...
    realisationPercentage(item) {
      ...
      // const totalRealisation = item.progress.shift()?.Realisation;
      const totalRealisation = item.progress[0]?.Realisation;
