    ...
    <div class="col-xl-12" data-aos="zoom-in">
      <div class="card custom-card">
        <div class="card-header justify-content-between">
          <div class="card-title">Liste des espaces de paiement</div>
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          ...
          >
            ...
            >
              <b class="text-center">Modifier une étape</b>
            </h2>
          </div>
            ...
            >
              <div>
                ...
                <div class="row mt-3 content-group">
                  <div class="col">
                    <div class="input-groupe">
                      <label for="userpassword">Description d'étape </label>
                      <textarea
                        class="form-control"
                        style="
              ...
              <div class="row mb-3">
                <div class="boutton">
                  <button
                    class=""
                    @click.prevent="
                      submitUpdateEtape('update-etape')
                      "
                    options="ModeFinancementOptions"
                    multiple
                  >
...
export default {
  ...
  computed: {
    ...
    totalPages() {
      return Math.ceil(this.EtapeOptions.length / this.itemsPerPage);
    },
    paginatedItems() {
      const startIndex = (this.currentPage - 1) * this.itemsPerPage;
      const endIndex = startIndex + this.itemsPerPage;
      return this.EtapeOptions.slice(startIndex, endIndex);
    },
  },
  data() {
    return {
  ...
  methods: {
    ...
    async submitUpdateEtape(modalId) {
      this.v$.step2.$touch();
      ...
      if (this.v$.$errors.length == 0) {
        ...
        try {
          ...
          if (response.data.status === "success") {
            ...
            this.successmsg(
              "Données de l'étape mises à jour",
              "Les données de l'étape ont été mises à jour avec succès !"
            );
            await this.fetchEtapes();
          }
        } catch (error) {
    ...
    filterByName() {
      ...
      if (this.search !== null) {
        ...
        this.EtapeOptions = this.data.filter((etape) => {
          const Nom = etape.Code || "";
          const Descriptions = etape.Description || "";
          // const Type = etape.modes.map((item) => item.Intitule) || "";
