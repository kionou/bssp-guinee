  ...
  <div>
    ...
    <div class="row task-card" data-aos="zoom-in">
      <div v-if="paginatedItems.length === 0" class="noresul">
        <span>
          Vous n'avez pas encore d'utilisateur, vous pouvez également en ajouter
          un !!
        </span>
      </div>
      <div
                ...
                <div class="d-flex align-items-center lh-1">
                  <div class="me-2">
                    <span class="avatar avatar-md avatar-rounded">
                      ...
                      />
                      <img v-else :src="user.photo" alt="Image utilisateur" />
                    </span>
                  </div>
                  <div>
                    <span class="d-block fw-semibold mb-1"
                      >{{ user.Nom }} {{ user.Prenoms }}</span
                    >
                ...
                <div class="btn-list w-100 d-flex justify-content-center">
                  <div>
                    ...
                    <button
                      ...
                      v-if="user.Statut === '0'"
                      v-tippy="{
                        content: 'Désactiver cet élément',
                        theme: 'custom',
                        animation: 'shift-away',
                        backgroundColor: '#FF5733',
                      }"
              ...
              <td>
                <div class="btn-list w-100 d-flex justify-content-center">
                  <button
                    ...
                    data-bs-toggle="modal"
                    v-tippy="{
                      content: 'Detail de l\'utilisateur',
                      theme: 'custom',
                      animation: 'shift-away',
                      backgroundColor: '#FF5733',
                    }"
                    data-bs-target="#detail_user"
                    @click="HandleIdDetail(user)"
                  >
                  ...
                  <button
                    ...
                    v-else-if="
                      user.roles[0]?.name !== 'Administrateur' &&
                      (hasPermission(4) || hasPermission(5))
                    "
                  >
                    <i class="ri-delete-bin-line"></i>
                  </button>
              ...
              <div>
                ...
                <div class="row mt-3 content-group">
                  ...
                  <div class="col col-md-6 col-sm-12">
                    <div class="input-groupe">
                      <label for="userpassword"
                        >Télephone <span class="text-danger">*</span></label
                      >
                      <MazPhoneNumberInput
                  ...
                  <div class="col col-md-6 col-sm-12">
                    <div class="mb-3 position-relative">
                      ...
                      <MazSelect
                        ...
                        size="sm"
                        rounded-size="sm"
                        :options="projetssOptions"
                        multiple
                        search
                      />
                      <small v-if="v$.step1.projets.$error">{{
                        v$.step1.projets.$errors[0].$message
                      }}</small>
                      <small v-if="resultError['projets']">{{
                        resultError["projets"]
                      }}</small>
                    </div>
                  </div>
                ...
                <div class="row mt-3 content-group">
                  ...
                  <div class="col col-md-6 col-sm-12">
                    <div class="mb-3 position-relative">
                      ...
                      <small v-if="!validatePasswordsMatch()"
                  ...
                  <div class="col col-md-6 col-sm-12">
                    <div class="mb-3 position-relative">
                      ...
                      <MazSelect
                        ...
                        search
                      />
                      <small v-if="v$.step2.projets.$error">{{
                        v$.step2.projets.$errors[0].$message
                      }}</small>
                      <small v-if="resultError['projets']">{{
                        resultError["projets"]
                      }}</small>
                  ...
                  <div class="col col-md-6 col-sm-12">
                    <div class="mb-3 position-relative">
                      ...
                      <small v-if="v$.step2.region.$error">{{
                        v$.step2.region.$errors[0].$message
                      }}</small>
                      <small v-if="resultError['region']">{{
                        resultError["region"]
                      }}</small>
            ...
            >
                  ...
                  <div class="col">
                    <div class="mb-3 position-relative">
                      ...
                      <MazInput
                        ...
                        rounded-size="sm"
                      />
                      <small v-if="v$.verifier.password.$error">{{
                        v$.verifier.password.$errors[0].$message
                      }}</small>
                      <small v-if="resultError['password']">{{
                        resultError["password"]
                      }}</small>
              ...
              <div class="row mb-3">
                <div class="boutton">
                  <button
                    class=""
                    @click.prevent="ValiderUpdate('valider_update')"
                  >
                    Valider
                  </button>
                </div>
        ...
        <div class="modal-content">
          ...
          >
            <h2
              ...
              style="font-size: 22px !important"
            >
              <b class="text-center">Detail de l'utilisateur </b>
            </h2>
          </div>
          <div class="modal-body px-4">
            <div
            ...
            <div
              ...
              >
                <div class="mt-1">
                  ...
                  <span
                    class="fw-semibold fs-16"
                    data-bs-toggle="tooltip"
                    title="Prenoms de l'utilisateur"
                    >{{ detailUser.Prenoms }}</span
                  >
                </div>
              </div>
              <div
              ...
              >
                <div class="mt-1">
                  ...
                  <span
                    class="fw-semibold fs-16"
                    data-bs-toggle="tooltip"
                    title="Pseudo de l'utilisateur"
                    >{{ detailUser.username }}</span
                  >
                </div>
              </div>
              <div
              ...
              >
                <div class="mt-1">
                  ...
                  <span
                    ...
                    class="fw-semibold fs-16"
                    data-bs-toggle="tooltip"
                    title="Whatsapp de l'utilisateur"
                    >{{ detailUser.Whatsapp }}</span
                  >
                </div>
              </div>
              <div
              ...
              >
                <div  class="mt-1">
                  ...
                  <span
                    ...
                    class="fw-semibold fs-16"
                    data-bs-toggle="tooltip"
                    title="Region de l'utilisateur"
                    >{{ detailUser.region?.NomRegion }}</span
                  >
                </div>
              </div>
              <div v-if="detailUser.roles"
              ...
              >
                <div class="mt-1">
                  ...
                  >{{ detailUser.roles[0]?.name }}</span>  
                </div>
              </div>
              <div v-if="detailUser.Statut"
              ...
              >
                <div class="mt-1">
                  ...
                  <span
                    ...
                    class="fw-semibold fs-16"
                    :class="{'badge bg-success text-white p-1 ': detailUser.Statut === '1', 'badge bg-warning text-white p-1 ': detailUser.Statut === '0'}"
                    data-bs-toggle="tooltip"
                    title="Statut de l'utilisateur"
                  >{{ detailUser.Statut === '1' ? 'Actif' : 'Inactif'}}</span>  
                </div>
              </div>
              <div class="col-md-12">
                <div
                ...
                >
                  ...
                  >
                    ...
                    <tbody data-aos="fade-up" data-aos-duration="1000">
                      <tr
                        v-for="projet in detailUser?.projects"
                        :key="projet.id"
                      >
                        <td>
                         <div v-if="projet?.projet?.id" @click="HandleIdDetailProjet(projet?.projet?.id)" class="cursor-pointer" >
                          <span>{{ projet?.projet?.Sigle }}</span>
...
export default {
  ...
  // Extraire les sigles valides
  const projects = user.projects
    .map((projet) => projet.projet?.Sigle)
    .filter((sigle) => sigle);

  // Garder seulement les 3 premiers et ajouter "etc..." si plus de 3
  if (projects.length > 3) {
    return projects.slice(0, 3).join(", ") + " etc...";
  }
  
  return projects.join(", ");
},
HandleIdDetailProjet(id){
  this.closeModal('detail_user');
  this.$router.push({ name: 'detail-projet', params: { id: id } });
},
