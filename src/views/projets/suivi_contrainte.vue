      ...
      <div class="card p-2 ">
        ...
        <div class="card">
          <div class="card-header">
            <div class="card-title">
              <h5 class="mb-0 fw-semibold fs-14">
                Information sur le suivi contrainte
              </h5>
            </div>
              ...
              <div class="row gy-2 justify-content-center" style="
                ...
                <div>
                  <div class="row">
                    ...
                    <div class="col-12">
                      <p class="mb-0"><span class="fw-semibold fs-14">suivi du : </span> <span class=" text-success fs-15 fw-bolder" > {{data.IntituleIndicateur}}</span> </p>
                    </div>
                    <div class="col-12">
                      <p class="mb-0"><span class="fw-semibold fs-14">info : </span> <span class=" text-success fs-15 fw-bolder" > {{data.IntituleIndicateur}}</span> </p>
                    </div>
